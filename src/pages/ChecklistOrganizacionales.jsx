...
export default function ChecklistOrganizacionales() {
  const [controles, setControles] = useState(() => {
    return JSON.parse(localStorage.getItem("iso27001_checklist_organizacional")) || [];
  });
  ...
  return (
    <div className="checklist-page">
      <h1>Checklist - Dominio Organizacionales</h1>
      <p>
        Controles A.5.1 – A.5.37: Políticas, roles, responsabilidades, inteligencia de amenazas,
      ...
      <div className="checklist-form">
        ...
        <input
          ...
          value={nuevo.evidencia}
          onChange={(e) => setNuevo({ ...nuevo, evidencia: e.target.value })}
        />
        <input
          type="text"
        ...
        />
        <button className="btn primary" onClick={agregarControl}>
          Agregar control
        </button>
      </div>
        ...
        <tbody>
          {controles.map((c, i) => (
            <tr key={i}>
              ...
              <td>
                <button className="btn small danger" onClick={() => eliminarControl(i)}>
                  Eliminar
                </button>
              </td>
            </tr>
