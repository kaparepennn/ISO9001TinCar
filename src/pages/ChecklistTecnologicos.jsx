...
export default function ChecklistTecnologicos() {
  const [controles, setControles] = useState(() =>
    JSON.parse(localStorage.getItem("iso27001_checklist_tecnologico")) || []
  );
  ...
  useEffect(() => {
    localStorage.setItem("iso27001_checklist_tecnologico", JSON.stringify(controles));
  }, [controles]);
  ...
  return (
    <div className="checklist-page">
      <h1>Checklist - Dominio Tecnológicos</h1>
      <p>Controles A.8.1 – A.8.34: criptografía, seguridad en redes, control de acceso, protección de datos, etc.</p>

      <div className="checklist-form">
        <input type="text" placeholder="Código (ej. A.8.1)" value={nuevo.codigo} onChange={(e) => setNuevo({ ...nuevo, codigo: e.target.value })} />
